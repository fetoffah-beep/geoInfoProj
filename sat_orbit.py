...
#if entered wrong/non existing name print error message
...
#graph
sv_number=input("Enter prn number of sv (es: 01, 02, 15): ")
prn_used='G'+str(sv_number)
#print(prn_used)
sv_x=[]
sv_y=[]
sv_z=[]
...
for i in range(1, len(sv_x)+1):
    ...
    sv_lat.append(lat_deg)
    sv_long.append(long_deg)
...
plt.plot(sv_long, sv_lat, 'r', transform=ccrs.Geodetic());
